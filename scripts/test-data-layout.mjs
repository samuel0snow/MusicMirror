...
export function ensureTestDataLayout(dataDir) {
  for (const dir of ['exports', 'explorations', 'analyses/aesthetic-v2', 'reviews/red-heart-time', 'reviews/song-memory-coverage', 'inputs/recent-red-heart', 'diagnostics/wiki', 'diagnostics/scripts', 'temporary/qr'])
...
- analyses/aesthetic-v2/<计算时间>/：私人派生审美JSON/Markdown、来源manifest和旧指数参考，不修改旧快照。
