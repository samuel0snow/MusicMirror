...
后续客户端核验：周报2小时8分钟、8月8小时55分钟与汇总128、535一致，对应周/月汇总按分钟计。周报差异来自30分钟播客。2025年度客户端202小时、1954首，与年度playDuration按秒换算后的202小时31分4秒及playNum=1954相符；年度时长仅核验到整小时显示精度，计数是否去重仍未知。累计与单曲字段单位仍独立待验，详见[时长核验](listening-duration-verification-2026-09-18.md)。
